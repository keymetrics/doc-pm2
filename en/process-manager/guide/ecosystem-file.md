...
For more information about available properties, check the [ecosystem file reference]({{ site.baseurl }}{% link en/process-manager/reference/ecosystem-file.md %}).
...
[Process Management]({{ site.baseurl }}{% link en/process-manager/guide/process-management.md %})
