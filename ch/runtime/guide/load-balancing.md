...
查看我们的 [教程]({{ site.baseurl }}{% link ch/runtime/best-practices/stateless-application.md %})，建立您的无状态应用。
...
通过我们的[教程]({{ site.baseurl }}{% link ch/runtime/best-practices/graceful-shutdown.md %})获得帮助，设置正常关机。
